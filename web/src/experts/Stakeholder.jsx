...
const Stakeholder = forwardRef(({
    ...
    name="Julia",
    age=23,
    target_phone=null, // international format "+1 234 567 8901; null => may call any number
    target_language="es-CL", // ex. es-CL, or en-US; TODO: null => auto-detect
    user_name="Pablo",
    user_role="CEO",
    user_company="",
    style,
    ...
    const meta = {
        ...
        */
        ...
        study: study,
        max_num_iterations: 5,  // 3-50; 25 is the default, 5 is enough for testing (more is better but the price is higher)
