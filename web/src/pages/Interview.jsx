...
function Interview() {
    ...
    return (
        ...
        <Meeting 
          ...
          onInit={(experts)=>{
            // avatar state holds an object with the avatar's name as the key and some metadata (like picture) as the value (for the chat)
            setAvatars(experts);
          }}
          ...
          <Stakeholder ref={testerPic} user_name="Pablo" target_language="es-CL" />
        </Meeting>
        {visible===true && (
            <>
